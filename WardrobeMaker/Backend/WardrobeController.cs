...
namespace WardrobeMaker
{
    ...
    public class WardrobeController : ControllerBase
    {
        ...
        public WardrobeController(WardrobeManager manager, IWebHostEnvironment environment)
        {
            _manager = manager;
        ...
        public IActionResult ToggleLaundryStatus(string itemId)
        {
            ...
            if (!_manager.ToggleLaundryStatus(itemId))
                return StatusCode(500, new { message = "Unable to update laundry status." });
        ...
        public IActionResult ScheduleOutfit([FromBody] ScheduleRequest request)
        {
            ...
            _manager.UpdateSchedule(request.Date, request.OutfitID);
